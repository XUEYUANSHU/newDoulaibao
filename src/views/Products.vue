...
//        option:Object
    ...
    data(){
      ...
      methods: {
          chooseType(){
                this.$refs['slider1'].className=(this.$refs['slider1'].className=="close1")?"open1":"close1";
                this.$refs['slider2'].className=( this.$refs['slider2'].className=="close2")?"open2":"close2";
