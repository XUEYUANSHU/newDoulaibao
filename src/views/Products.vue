<template>
    <div class="products">
        <commonHeader url='-1' title="产品"></commonHeader>
        <div class="listType">
            <ul>
                <li :class=" (!activeName)? 'activeName': ''" @click="selected()"><img src="../assets/img/全部产品页-06.png"
                                                                                       alt=""></li>
                <li :class=" activeName== '0'? 'activeName': ''" @click="selected('0')"><img
                    src="../assets/img/全部产品页-07.png" alt=""></li>
                <li :class=" activeName== '1'? 'activeName': ''" @click="selected('1')"><img
                    src="../assets/img/全部产品页-08.png" alt=""></li>
                <li :class=" activeName== '2'? 'activeName': ''" @click="selected('2')"><img
                    src="../assets/img/全部产品页-09.png" alt=""></li>
            </ul>
        </div>
