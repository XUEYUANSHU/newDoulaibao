<template>
    <div>
        <commonHeader url='-1' title="提现"></commonHeader>
        <div class="tixian">
            ...
            <div class="formWraper">
                ...
                <div class="balance"><span>零钱余额</span><span>¥{{balance}}</span><span class="yellowC" @click="allCash">, 全部提现</span>
                </div>
                <div class="bankLists" @click="select(0, 'wx')">
                    <div class="left"><img src="../assets/img/微信支付@2x.png" class="icon-weixin"> <span>微信</span></div>
                    <div class="right"><i class="iconfont" :class="activeName == 'wx' ? 'activeName' : ''">&#xe601;</i>
                    </div>
                </div>

                <div class="addbank" v-if="banklist.length== 0" @click="bindBank"><i class="iconfont">&#xe63e;</i><span>绑定银行卡</span>
                </div>
                <div class="bankLists" v-for="(item, idx) in banklist" :key="idx " @click="select(1,idx)">
                    <div class="left"><img src="../assets/img/银行卡@2x.png" class="icon-bank">
                        <span>{{item.bankName}}</span></div>
                    <div class="right"><i class="iconfont" :class="activeName == idx ? 'activeName' : ''"
                                          @click="select(0, 'wx')">&#xe601;</i></div>
                </div>
